...
const SOCIALS: { label: string; href: string; icon: React.ReactNode }[] = [
  {
    ...
    href: "#",
    icon: (
      <path d="M13.5 21v-7h2.3l.4-2.7h-2.7V9.5c0-.8.2-1.3 1.4-1.3H16V5.8c-.3 0-1.1-.1-2-.1-2 0-3.4 1.2-3.4 3.5v1.9H8.2V14h2.4v7z" />
    ),
  },
  {
    label: "X",
    href: "#",
    icon: (
      <path d="M17.5 4h2.6l-5.7 6.5L21 20h-5.3l-4.1-5.4L6.8 20H4.2l6.1-7L4 4h5.4l3.7 4.9zm-.9 14.4h1.4L8.4 5.5H6.9z" />
    ),
  },
  {
    label: "LinkedIn",
    href: "#",
    icon: (
      <path d="M6.9 8.8V19H3.7V8.8zM5.3 4.3a1.9 1.9 0 1 1 0 3.7 1.9 1.9 0 0 1 0-3.7zM9 8.8h3.1v1.4h.05c.43-.8 1.5-1.7 3.05-1.7 3.25 0 3.85 2.1 3.85 4.9V19h-3.2v-4.9c0-1.2 0-2.7-1.65-2.7s-1.9 1.3-1.9 2.6V19H9z" />
    ),
  },
  {
    label: "Instagram",
  ...
  return (
    <footer className="border-t border-paper/10 bg-[#08080A]">
      <div className="mx-auto max-w-7xl px-[clamp(20px,5vw,88px)] py-16">
        ...
        {/* trust badges (BBB is a placeholder; supply the official asset and a real
            license number, and confirm accreditation, before launch) */}
        <div className="mt-12 flex flex-wrap items-center gap-4 border-t border-paper/10 pt-8">
        ...
        {/* bottom bar */}
        <div className="mt-8 flex flex-col gap-4 border-t border-paper/10 pt-6 text-sm text-paper/45 md:flex-row md:items-center md:justify-between">
