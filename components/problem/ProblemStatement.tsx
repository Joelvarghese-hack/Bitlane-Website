 ...
 */
const PAINS = [
  { text: "Quotes that balloon on moving day", top: "15%", side: "left", off: "15%" },
  { text: "Movers who show up late, or never", top: "29%", side: "right", off: "16%" },
  { text: "Scratched walls and broken furniture", top: "45%", side: "left", off: "22%" },
  { text: "Hidden fees buried in the fine print", top: "60%", side: "right", off: "21%" },
  { text: "Boxes tossed around with zero care", top: "76%", side: "left", off: "16%" },
  { text: "Getting ghosted when you have a question", top: "90%", side: "right", off: "15%" },
] as const;
